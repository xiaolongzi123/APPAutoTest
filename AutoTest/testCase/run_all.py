...
from testCase.test_export import MyTestCaseExport
from testCase.test_theme_map import MyTestCaseTheme
...
if __name__ == "__main__":
    ...
    suite.addTests(unittest.TestLoader().loadTestsFromTestCase(MyTestCaseExport))
